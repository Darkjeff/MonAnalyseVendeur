...
/**
 * \file    monanalysevendeur/admin/setup.php
 * \ingroup monanalysevendeur
 * \brief   MonAnalyseVendeur setup page.
 */
...
require_once '../lib/monanalysevendeur.lib.php';
//require_once "../class/myclass.class.php";

// Translations
$langs->loadLangs(array("admin", "monanalysevendeur@monanalysevendeur"));
...
} elseif ($action == 'specimen')
{
	...
	{
		$file = dol_buildpath($reldir."core/modules/monanalysevendeur/doc/pdf_".$modele."_".strtolower($tmpobjectkey).".modules.php", 0);
		if (file_exists($file))
		{
			$filefound = 1;
...
} elseif ($action == 'setmod')
{
	...
	$tmpobjectkey = GETPOST('object');
	$constforval = 'MONANALYSEVENDEUR_'.strtoupper($tmpobjectkey)."_ADDON";
...
$page_name = "MonAnalyseVendeurSetup";
llxHeader('', $langs->trans($page_name));

// Subheader
$linkback = '<a href="'.($backtopage ? $backtopage : DOL_URL_ROOT.'/admin/modules.php?restore_lastsearch_values=1').'">'.$langs->trans("BackToModuleList").'</a>';

print load_fiche_titre($langs->trans($page_name), $linkback, 'object_monanalysevendeur@monanalysevendeur');

// Configuration header
$head = monanalysevendeurAdminPrepareHead();
dol_fiche_head($head, 'settings', '', -1, "monanalysevendeur@monanalysevendeur");

// Setup page goes here
echo '<span class="opacitymedium">'.$langs->trans("MonAnalyseVendeurSetupPage").'</span><br><br>';
					...
					while (($file = readdir($handle)) !== false)
					{
						if (strpos($file, 'mod_'.strtolower($myTmpObjectKey).'_') === 0 && substr($file, dol_strlen($file) - 3, 3) == 'php')
						{
							...
							if ($module->isEnabled())
							{
								...
								$constforvar = 'MONANALYSEVENDEUR_'.strtoupper($myTmpObjectKey).'_ADDON';
