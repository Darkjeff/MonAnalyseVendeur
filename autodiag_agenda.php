...
/**
 *  \file       autodiag_agenda.php
 *  \ingroup    monanalysevendeur
 *  \brief      Page of Autodiag events
 */
...
$hookmanager->initHooks(array('autodiagagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("Autodiag"), -1, 'object_'.$object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read)))
	{
		...
		//print load_fiche_titre($langs->trans("ActionsOnAutodiag"), '', '');
