...
$sql .= "  ROUND(SUM(IF(cat.label='Armentières',ec.entity,0)),0) AS 'Armentières',";
$sql .= "  ROUND(SUM(IF(cat.label='Abbeville CV',ec.entity,0)),0) AS 'Abbeville CV',";
$sql .= "  ROUND(SUM(IF(cat.label='Boulogne',ec.entity,0)),0) AS 'Boulogne',";
$sql .= "  ROUND(SUM(IF(cat.label='Dury',ec.entity,0)),0) AS 'Dury',";
$sql .= "  ROUND(SUM(IF(cat.label='Auchy les Mines',ec.entity,0)),0) AS 'Auchy les Mines',";
$sql .= "  ROUND(SUM(IF(cat.label='Aire sur la Lys',ec.entity,0)),0) AS 'Aire sur la Lys',";
$sql .= "  ROUND(SUM(IF(cat.label='Longuenesse',ec.entity,0)),0) AS 'Longuenesse',";
$sql .= "  ROUND(SUM(IF(cat.label='Abbeville CC',ec.entity,0)),0) AS 'Abbeville CC',";
$sql .= "  ROUND(SUM(IF(cat.label='Hazebrouck',ec.entity,0)),0) AS 'Hazebrouck',";
