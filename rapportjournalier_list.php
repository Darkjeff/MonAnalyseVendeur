...
/**
 *   	\file       rapportjournalier_list.php
 *		\ingroup    monanalysevendeur
 *		\brief      List page for rapportjournalier
 */
...
require_once __DIR__.'/class/rapportjournalier.class.php';
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'rapportjournalierlist'; // To manage different context of search
...
$hookmanager->initHooks(array('rapportjournalierlist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook))
{
	...
	// Mass actions
	$objectclass = 'Rapportjournalier';
	$objectlabel = 'Rapportjournalier';
...
//$help_url="EN:Module_Rapportjournalier|FR:Module_Rapportjournalier_FR|ES:Módulo_Rapportjournalier";
$help_url = '';
$title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("Rapportjournaliers"));
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/monanalysevendeur/rapportjournalier_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/monanalysevendeur/rapportjournalier_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendRapportjournalierRef";
$modelmail = "rapportjournalier";
$objecttmp = new Rapportjournalier($db);
