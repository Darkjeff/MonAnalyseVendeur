...
class Contacttracking extends CommonObject
{
    ...
    public $fields = array(
        ...
        'fk_soc' => array('type' => 'integer:Societe:societe/class/societe.class.php', 'label' => 'ThirdParty', 'visible' => 1, 'enabled' => 1, 'position' => 502, 'notnull' => 1, 'index' => 1, 'searchall' => 1, 'help' => "LinkToThirparty",),
        'fk_contact' => array('type' => 'integer:Contact:contact/class/contact.class.php', 'label' => 'Contact', 'visible' => 1, 'enabled' => 1, 'position' => 503, 'notnull' => -1, 'searchall' => 1,),
