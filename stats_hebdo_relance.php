 ...
 * View
 */
llxHeader ( '', 'Stats Hebdo Relance' );

$textprevyear = "<a href=\"stats_hebdo_relance.php?year=" . ($year_current - 1) . "\">" . img_previous () . "</a>";
$textnextyear = " <a href=\"stats_hebdo_relance.php?year=" . ($year_current + 1) . "\">" . img_next () . "</a>";

print_fiche_titre ( $langs->trans("Rapport Relance Hebdomadaire")." ".$textprevyear." ".$langs->trans("Year")." ".$year_start." ".$textnextyear);
...
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_1."',ct.entity,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_1."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_2."',ct.entity,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_2."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_3."',ct.entity,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_3."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_4."',ct.entity,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_4."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_5."',ct.entity,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_5."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_6."',ct.entity,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_6."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_7."',ct.entity,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_7."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_8."',ct.entity,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_8."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_9."',ct.entity,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_9."',";
...
$sql .= "  AND ct.fk_event is not null ";
