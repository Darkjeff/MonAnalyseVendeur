...
/**
 *  \file       monanalysevendeur/core/modules/monanalysevendeur/doc/pdf_standard.modules.php
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
	    ...
	    if ($conf->monanalysevendeur->dir_output.'/myobject')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->monanalysevendeur->dir_output.'/myobject';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->monanalysevendeur->dir_output.'/myobject/'.$objectref;
