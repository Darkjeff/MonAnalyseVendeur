...
/**
 * \file    test/phpunit/MonAnalyseVendeurFunctionalTest.php
...
/**
 * Class MonAnalyseVendeurFunctionalTest
 *
 ...
 *
 * @package Testmonanalysevendeur
 */
class MonAnalyseVendeurFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMonAnalyseVendeur')->click();
		} else {
			// Disable the module
			$this->byHref('modMonAnalyseVendeur')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/monanalysevendeur/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('monanalysevendeur/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/monanalysevendeur/admin/about.php');
		$this->authenticate();
		return $this->assertContains('monanalysevendeur/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('monanalysevendeurwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMonAnalyseVendeur_MonAnalyseVendeurTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMonAnalyseVendeur_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
