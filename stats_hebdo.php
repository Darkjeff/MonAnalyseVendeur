...
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_1."',rj.nb_traitement,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_1."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_2."',rj.nb_traitement,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_2."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_3."',rj.nb_traitement,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_3."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_4."',rj.nb_traitement,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_4."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_5."',rj.nb_traitement,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_5."',";
...
$sql = "SELECT WEEK(rj.date_creation) AS Week,";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_1."',rj.nb_box,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_1."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_2."',rj.nb_box,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_2."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_3."',rj.nb_box,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_3."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_4."',rj.nb_box,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_4."',";
$sql .= "  ROUND(SUM(IF(cat.label='".$conf->global->MONANALYSEVENDEUR_MAG_5."',rj.nb_box,0)),0) AS '".$conf->global->MONANALYSEVENDEUR_MAG_5."',";
