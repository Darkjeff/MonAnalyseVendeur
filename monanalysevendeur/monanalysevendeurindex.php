...
/**
 *	\file       monanalysevendeur/monanalysevendeurindex.php
 *	\ingroup    monanalysevendeur
 *	\brief      Home page of monanalysevendeur top menu
 */
...
$langs->loadLangs(array("monanalysevendeur@monanalysevendeur"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->monanalysevendeur->myobject->read) accessforbidden();
...
print load_fiche_titre($langs->trans("MonAnalyseVendeurArea"), '', 'monanalysevendeur.png@monanalysevendeur');
...
// Draft MyObject
if (! empty($conf->monanalysevendeur->enabled) && $user->rights->monanalysevendeur->read)
{
	$langs->load("orders");
